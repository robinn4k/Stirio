...
import { PARITY_EXCLUDE_PREFIXES } from '../js/i18n-exclusions.js';
...
// PARITY_EXCLUDE_PREFIXES now lives in js/i18n-exclusions.js so the runtime
// admin console can compute coverage % using the same exclusion list. Don't
// duplicate it here — edit the source module instead.
