export const rounds = [
  {
    ...
    color: "#c9971c",
    questions: [
      { q: "How many official cocktail categories does the IBA recognize?", a: ["3", "2", "4", "5"], exp: "The IBA recognizes 3 categories: 'The Unforgettables', 'Contemporary Classics', and 'New Era Drinks'." },
      { q: "What is the base spirit of a Negroni?", a: ["Gin", "Vodka", "Rum", "Whisky"], exp: "The classic Negroni is made with gin, Campari, and sweet vermouth in equal proportions." },
      { q: "Which IBA cocktail contains tequila, triple sec, and lime juice?", a: ["Margarita", "Cosmopolitan", "Daiquiri", "Gimlet"], exp: "The Margarita is one of the most famous IBA cocktails, made with tequila, triple sec, and lime." },
      { q: "What is the distinguishing ingredient of a Sazerac?", a: ["An absinthe rinse", "Dry vermouth", "Orange bitters", "Grenadine syrup"], exp: "The Sazerac is served in a glass rinsed with absinthe, giving it its unique aroma." },
      { q: "What does IBA stand for?", a: ["International Bartenders Association", "International Bar Alliance", "Institute of Beverage Arts", "International Brewing Academy"], exp: "IBA stands for International Bartenders Association, founded in 1951." },
      { q: "Which IBA cocktail is made with Champagne and Cognac?", a: ["Champagne Cocktail", "French 75", "Kir Royale", "Bellini"], exp: "The classic IBA Champagne Cocktail uses a sugar cube, Angostura bitters, Cognac, and Champagne." },
      { q: "Which IBA cocktail contains Campari, sweet vermouth, and gin?", a: ["Negroni", "Americano", "Boulevardier", "Aperol Spritz"], exp: "The Negroni is the perfect blend of gin, Campari, and sweet vermouth." },
      { q: "Which IBA cocktail is served tall with rum, mint, lime, and soda?", a: ["Mojito", "Caipirinha", "Dark and Stormy", "Ti' Punch"], exp: "The Cuban Mojito is one of the world's most popular cocktails, with white rum, mint, lime, and soda." },
      { q: "Which IBA cocktail contains vodka, tomato juice, and spices?", a: ["Bloody Mary", "Harvey Wallbanger", "Sea Breeze", "Cosmopolitan"], exp: "The Bloody Mary is the ultimate reviving cocktail, made with vodka and tomato juice." },
      { q: "The IBA Dry Martini is made with gin and...", a: ["Dry vermouth", "Sweet vermouth", "Triple sec", "Cointreau"], exp: "The classic IBA Dry Martini combines gin with dry vermouth and is garnished with an olive or lemon twist." }
    ]
  },
  {
    id: 2,
    title: "Classic Spirits",
    subtitle: "World Distillates",
    icon: "🥃",
    color: "#a0522d",
    questions: [
      { q: "What minimum percentage of corn must bourbon contain?", a: ["51%", "60%", "70%", "80%"], exp: "To be classified as bourbon, the mash bill must contain at least 51% corn." },
      { q: "From which plant is tequila made?", a: ["Blue agave", "Mezcal agave", "Maguey", "Nopal"], exp: "Tequila can only be made from Agave Tequilana Weber, blue variety, in designated regions of Mexico." },
      { q: "How many years must Scotch Whisky age at minimum?", a: ["3 years", "5 years", "10 years", "1 year"], exp: "Scottish law requires a minimum of 3 years aging in oak casks." },
      { q: "What is Cognac?", a: ["A French brandy from the Cognac region", "An aged French rum", "An aged Calvados", "A premium Armagnac"], exp: "Cognac is a wine brandy produced in the Cognac region, in the Charente department of France." },
      { q: "How does mezcal differ from tequila?", a: ["Mezcal can be made from any agave; tequila only from blue agave", "Mezcal is sweeter", "Tequila has a higher ABV", "They only differ by region"], exp: "Mezcal can be produced from more than 30 agave varieties, while tequila uses exclusively blue agave." },
      { q: "What is ABV?", a: ["Alcohol By Volume", "Average Barrel Value", "Aged Barrel Vintage", "Alcohol Base Value"], exp: "ABV stands for Alcohol By Volume and expresses the percentage of ethanol in a drink." },
      { q: "Which botanical is essential in gin?", a: ["Juniper", "Coriander", "Angelica", "Cardamom"], exp: "By law, gin must have juniper (Juniperus communis) as its predominant botanical." },
      { q: "What is the raw material for rum?", a: ["Sugarcane", "Agave", "Barley", "Corn"], exp: "Rum is distilled from sugarcane juice or molasses, a byproduct of sugar manufacturing." },
      { q: "What characteristic botanical does aquavit have?", a: ["Caraway or dill", "Juniper", "Anise", "Fennel"], exp: "Scandinavian aquavit owes its distinctive flavor to caraway or dill." },
      { q: "What is Calvados?", a: ["Apple brandy from Normandy", "Distilled cider from Brittany", "Apple rum from the Caribbean", "Pear liqueur from Alsace"], exp: "Calvados is a protected designation of origin for apple cider brandy produced in Normandy, France." }
    ]
  },
  {
    id: 3,
    title: "Bar Techniques",
    subtitle: "The Art of Cocktail Making",
    icon: "🔀",
    color: "#2980b9",
    questions: [
      { q: "What does 'muddling' mean in cocktail making?", a: ["Crushing ingredients in the glass", "Shaking with ice", "Straining the drink", "Flambéing the cocktail"], exp: "Muddling involves gently crushing fruits, herbs, or sugar at the bottom of the glass to extract their aromas and juices." },
      { q: "What is the main difference between shaking and stirring a cocktail?", a: ["Shaking adds more air and dilution; stirring is more subtle", "Shaking preserves temperature better", "Stirring mixes faster", "There is no significant difference"], exp: "Shaking oxygenates the drink and dilutes it faster; stirring is for more delicate cocktails that shouldn't be clouded." },
      { q: "What is a 'dry shake'?", a: ["Shaking without ice, usually with egg white", "Shaking with dry ice", "Shaking without alcohol", "Shaking in a dry shaker"], exp: "The dry shake (without ice) is used to emulsify egg white or cream before adding ice, achieving better texture." },
      { q: "Which technique involves slowly pouring over a spoon to create layers?", a: ["Floating", "Rolling", "Straining", "Muddling"], exp: "Floating uses a bar spoon to gently guide liquid and create layers of different densities." },
      { q: "What does ordering a cocktail 'on the rocks' mean?", a: ["Served over ice cubes", "Without ice, at room temperature", "With crushed ice", "With a spherical ice ball"], exp: "'On the rocks' means the cocktail is served directly over ice cubes in the glass." },
      { q: "What is 'fat washing'?", a: ["Infusing a spirit with fat to add flavor", "Cleaning the glass with fat", "A filtration technique with butter", "Adding coconut oil to the cocktail"], exp: "Fat washing is a technique where fat (butter, bacon, etc.) is mixed with a spirit then frozen to separate and filter out the fat, leaving the flavor." },
      { q: "What does 'neat' mean when ordering a spirit?", a: ["The spirit alone, without ice or mixer", "With a little water", "Very cold, without ice", "With a pinch of salt"], exp: "'Neat' means the spirit as-is, without ice, water, or any other ingredient." },
      { q: "What is the purpose of 'rolling' in cocktail making?", a: ["Gently mixing by pouring between two vessels", "Shaking with a circular motion", "Rolling the shaker across the bar", "Pouring over an ice stone"], exp: "Rolling involves pouring the cocktail from one vessel to another multiple times to mix gently with minimal dilution." },
      { q: "What does 'expressing' a citrus peel mean in a cocktail?", a: ["Twisting the peel over the glass to release essential oils", "Squeezing the juice from the fruit", "Grating the peel over the drink", "Burning the peel near the glass"], exp: "Expressing the peel means twisting it over the cocktail to release aromatic essential oils that float on the surface." },
      { q: "How many seconds does it take to properly chill a well-shaken cocktail with ice?", a: ["10-15 seconds", "30-45 seconds", "5 seconds", "60 seconds"], exp: "Shaking vigorously for 10-15 seconds is enough to properly chill a cocktail and achieve the right dilution." }
    ]
  },
  {
    id: 4,
    title: "Glassware & Tools",
    subtitle: "The Bartender's Equipment",
    icon: "🫗",
    color: "#27ae60",
    questions: [
      { q: "What type of glass is used for a classic Martini?", a: ["Martini (cocktail) glass", "Champagne flute", "Balloon glass", "Highball glass"], exp: "The Martini is served in a cocktail or Martini glass, with its iconic triangular shape and long stem." },
      { q: "What is a jigger?", a: ["A double-cup measuring tool for exact portions", "A fine mesh strainer", "A long bar spoon", "A small type of shaker"], exp: "The jigger is the bartender's standard measuring tool, usually with two compartments of different volumes (1oz and 1.5oz or similar)." },
      { q: "What is a Hawthorne strainer used for?", a: ["Straining drinks while retaining ice and pulp with its spring", "Measuring the volume of a cocktail", "Adding ice to the glass", "Stirring ingredients in the shaker"], exp: "The Hawthorne strainer has a metal spring that retains ice, fruit, and herbs when pouring the cocktail into the glass." },
      { q: "What is the difference between a flute and a coupe glass?", a: ["The flute preserves bubbles; the coupe is wide and shallow", "The coupe is for Champagne; the flute for sparkling wine", "They are interchangeable", "The flute has more capacity"], exp: "The flute extends the bubble path preserving carbonation; the coupe is retro, wide and allows better aroma but loses gas quickly." },
      { q: "What is the standard 'shot' size in the UK?", a: ["25 ml or 35 ml", "20 ml", "50 ml", "30 ml"], exp: "In the UK, a standard single shot is 25 ml (or 35 ml in Scotland), though it can vary by establishment." },
      { q: "What is a muddler used for?", a: ["Crushing fruits, herbs, and sugar in the glass", "Stirring the cocktail", "Measuring ingredients", "Decorating the rim of the glass"], exp: "The muddler is a wooden, plastic, or stainless steel tool used to crush ingredients and release their juices and aromas." },
      { q: "What is the main function of a long bar spoon?", a: ["Stirring cocktails and measuring small quantities", "Decoration only", "Serving as a small muddler", "Measuring ABV"], exp: "The long spoon allows stirring in tall glasses without splashing, and its standard volume (5ml) serves as a measure." },
      { q: "What is a 'Boston Shaker'?", a: ["A two-piece system: metal tin + glass or second tin", "A three-piece shaker with built-in strainer", "A shaker designed for two people", "A special shaker for hot cocktails"], exp: "The Boston Shaker consists of two vessels (usually two tins or a tin and a glass) that seal together for shaking." },
      { q: "In what glass is a Cuba Libre served?", a: ["Highball glass", "Old fashioned glass", "Martini glass", "Balloon glass"], exp: "The Cuba Libre (rum, cola, lime) is served in a highball glass, a tall straight glass of around 250-350 ml." },
      { q: "What is a Julep strainer?", a: ["A toothed metal strainer without a spring, for mixing glasses", "A smaller Hawthorne strainer", "A fine mesh for pulp", "The perforated cap of a shaker"], exp: "The Julep strainer is a simple perforated metal strainer designed to sit in a mixing glass." }
    ]
  },
  {
    id: 5,
    title: "Cocktail History",
    subtitle: "Origins & Legends",
    icon: "📜",
    color: "#8e44ad",
    questions: [
      { q: "In what year was the first recognized cocktail recipe book published?", a: ["1862", "1920", "1880", "1910"], exp: "'The Bartender's Guide' by Jerry Thomas was published in 1862 and is considered the first cocktail book." },
      { q: "How long did Prohibition last in the United States?", a: ["1920 to 1933", "1915 to 1930", "1925 to 1940", "1910 to 1925"], exp: "The Prohibition Act banned alcohol in the US from January 1920 until December 1933." },
      { q: "Where did the word 'cocktail' first appear in print?", a: ["The Balance, a New York newspaper, 1806", "The Times of London, 1820", "Le Monde of Paris, 1815", "The Boston Globe, 1800"], exp: "The first written definition of 'cocktail' appeared in The Balance and Columbian Repository newspaper on May 13, 1806." },
      { q: "Who wrote 'The Savoy Cocktail Book' (1930)?", a: ["Harry Craddock", "Jerry Thomas", "Dick Bradsell", "Dale DeGroff"], exp: "Harry Craddock, head bartender at the American Bar of the Savoy Hotel in London, wrote this classic in 1930." },
      { q: "At which Singapore hotel was the Singapore Sling invented?", a: ["Raffles Hotel", "Marina Bay Sands", "Fullerton Hotel", "Capella Singapore"], exp: "The Singapore Sling was created by Ngiam Tong Boon at the Long Bar of the Raffles Hotel around 1915." },
      { q: "What was 'bathtub gin' during Prohibition?", a: ["Illegal homemade gin produced during Prohibition", "A cocktail with gin and soda water", "Gin aged in barrels", "A high-quality craft distillate"], exp: "Bathtub gin was low-quality alcohol mixed with botanicals in illegal home distilleries during Prohibition." },
      { q: "What is considered the 'Golden Age' of cocktails?", a: ["Victorian era / pre-Prohibition (1860-1920)", "The 1950s-60s", "The 1980s", "The 2010s"], exp: "The pre-Prohibition era, especially 1860-1920, is the first Golden Age when the foundations of modern cocktail making were established." },
      { q: "How is Jerry Thomas known in cocktail history?", a: ["The father of American bartending", "The inventor of the Martini", "The creator of the Negroni", "The first US sommelier"], exp: "Jerry Thomas, author of the first cocktail book, is known as 'the father of American mixology'." },
      { q: "Which movement revitalized craft cocktail making in the early 21st century?", a: ["The craft cocktail / artisan mixology movement", "The tapas bar boom", "The craft beer revolution", "The natural wine movement"], exp: "From the 2000s, the craft cocktail movement reclaimed classic techniques and used fresh, quality ingredients, transforming the industry." },
      { q: "In which city did the Aperol Spritz become a modern popular drink?", a: ["Venice / Veneto, Italy", "Milan, Italy", "Rome, Italy", "Florence, Italy"], exp: "The Aperol Spritz has roots in the Veneto tradition; Aperol was created in Padua in 1919 and the spritz is a tradition of this region." }
    ]
  },
  {
    id: 6,
    title: "Tropics & Rum",
    subtitle: "Paradise in a Glass",
    icon: "🌴",
    color: "#e67e22",
    questions: [
      { q: "What is the base spirit of a Mojito?", a: ["White rum", "Aged rum", "Cachaça", "Gin"], exp: "The classic Cuban Mojito is made with white rum, fresh mint, lime, sugar, and soda water." },
      { q: "Where was the Piña Colada invented?", a: ["Puerto Rico", "Cuba", "Jamaica", "Colombia"], exp: "The Piña Colada is Puerto Rico's national cocktail, created in San Juan in the 1950s." },
      { q: "What does 'Mai Tai' mean in Tahitian?", a: ["Out of this world / Awesome!", "Drink of the sun", "Tropical nectar", "Toast of peace"], exp: "Mai Tai in Tahitian literally means 'out of this world'. When tasting it, Trader Vic said 'mai tai, roa ae' (out of this world, the best)." },
      { q: "What is Brazilian cachaça made from?", a: ["Fresh sugarcane juice", "Sugarcane molasses", "Corn", "Cassava"], exp: "Cachaça differs from rum in that it is distilled directly from fresh sugarcane juice, not molasses." },
      { q: "What is the difference between agricole rum and industrial rum?", a: ["Agricole is distilled from cane juice; industrial from molasses", "Agricole has a higher ABV", "Industrial is aged longer", "They only differ by brand"], exp: "Rhum agricole uses fresh cane juice with an herbaceous, earthy profile; industrial rum uses molasses with a sweeter profile." },
      { q: "Which classic cocktail contains cachaça, lime, and sugar?", a: ["Caipirinha", "Caipiroska", "Mojito", "Daiquiri"], exp: "The Caipirinha is Brazil's national cocktail: cachaça, chopped lime, white sugar, and crushed ice." },
      { q: "What is Falernum?", a: ["A Caribbean syrup with lime, almond, and clove", "A Jamaican coconut liqueur", "A Trinidad spiced rum", "A Barbados tropical bitter"], exp: "Falernum is an Antillean syrup or liqueur with notes of lime, almond, clove, and tropical spices, essential in tiki cocktails." },
      { q: "What is the most famous tiki cocktail created by Trader Vic?", a: ["Mai Tai", "Zombie", "Painkiller", "Jungle Bird"], exp: "Victor Bergeron 'Trader Vic' created the Mai Tai in 1944 in Oakland, California, as a tribute to Caribbean flavors." },
      { q: "What type of rum is used in a Dark 'n' Stormy?", a: ["Dark Bermuda rum (Gosling's)", "Cuban white rum", "Jamaican aged rum", "Barbados spiced rum"], exp: "The Dark 'n' Stormy is a Gosling's trademark from Bermuda: Gosling's Black Seal rum and ginger beer." },
      { q: "What is the essential ingredient in a 'Jungle Bird' cocktail?", a: ["Campari", "Aperol", "Peach liqueur", "Blue Curaçao"], exp: "The Jungle Bird (1978, Kuala Lumpur) combines dark rum, Campari, pineapple juice, lime juice, and simple syrup." }
    ]
  },
  {
    id: 7,
    title: "Gin & Tonic",
    subtitle: "The Perfect Botanical",
    icon: "🌿",
    color: "#16a085",
    questions: [
      { q: "What is London Dry Gin?", a: ["A gin style with no added sugar, distilled with natural botanicals", "Gin produced only in London", "Gin with a predominance of citrus", "Barrel-aged gin"], exp: "London Dry is a style (not a geographic origin) that requires distillation with natural botanicals, no artificial colorings or flavorings, and minimum added sugar." },
      { q: "Why does tonic water taste bitter?", a: ["It contains quinine, originally anti-malarial", "It has oak bark extract", "It has a high bicarbonate content", "It is made with sulfurous mineral water"], exp: "Quinine is the alkaloid from the cinchona tree bark that gives tonic water its characteristic bitterness; British soldiers in India used it against malaria." },
      { q: "What is sloe gin?", a: ["A gin liqueur macerated with sloe berries", "A dry gin with no extra botanicals", "A low-ABV gin", "A type of Scottish craft gin"], exp: "Sloe gin is made by macerating sloe berries (blackthorn fruit) in gin with sugar, producing a sweet, fruity, red-colored liqueur." },
      { q: "What is the difference between Old Tom Gin and London Dry?", a: ["Old Tom is slightly sweeter; London Dry is dry", "Old Tom has more botanicals", "London Dry has a higher ABV", "Old Tom is of Scottish origin"], exp: "Old Tom Gin, popular in the 18th century, has a sweeter profile than modern London Dry, serving as the link between Dutch jenever and modern gin." },
      { q: "Which classic cocktail contains gin, lemon juice, sugar, and soda?", a: ["Tom Collins", "Gimlet", "Southside", "Aviation"], exp: "The Tom Collins is a refreshing long drink: gin (originally Old Tom), lemon juice, simple syrup, and soda water." },
      { q: "What makes 'Navy Strength Gin' special?", a: ["It has a minimum strength of 57% ABV", "It is aged in naval barrels", "It is only produced in Admiralty distilleries", "It contains sea salt among its botanicals"], exp: "Navy Strength gin (57% ABV) was the strength that guaranteed if it spilled on gunpowder aboard Royal Navy ships, the powder would still ignite." },
      { q: "What is the most common botanical in Spanish-style Gin & Tonic?", a: ["Varies by gin; juniper always present", "Provençal lavender", "Pink peppercorn exclusively", "Green cardamom"], exp: "Spain led the gin tonic renaissance, using large balloon glasses, plenty of ice, and varied botanicals that complement the chosen gin." },
      { q: "Which country consumes the most gin per capita?", a: ["Philippines", "United Kingdom", "Spain", "United States"], exp: "The Philippines is the world's largest per-capita consumer of gin, where the Ginebra San Miguel brand dominates the market." },
      { q: "Which IBA cocktail contains gin, lime or lemon juice, and crème de cassis?", a: ["None; the Aviation has crème de violette", "Gimlet", "Clover Club", "Bee's Knees"], exp: "The Aviation contains gin, crème de violette, maraschino, and lemon juice. The Clover Club has raspberry. Do not confuse with crème de cassis (blackcurrant)." },
      { q: "What is jenever (genever)?", a: ["The Dutch ancestor of gin, more malty and full-bodied", "A German spiced gin", "A type of Dutch aquavit", "Gin aged in Holland"], exp: "Dutch jenever is the historical precursor to gin, with a softer, maltier profile. English soldiers called it 'Dutch Courage' in the 17th century." }
    ]
  },
  {
    id: 8,
    title: "Whisky & Bourbon",
    subtitle: "The Nobility of Spirits",
    icon: "🥃",
    color: "#922b21",
    questions: [
      { q: "What does 'single malt' mean in Scotch Whisky?", a: ["Made at a single distillery with malted barley", "Distilled only once", "A single unblended barrel", "Produced only in the Highlands"], exp: "Single Malt Scotch Whisky comes from a single distillery, made exclusively with malted barley and water." },
      { q: "Which US state produces over 90% of the world's bourbon?", a: ["Kentucky", "Tennessee", "Indiana", "Texas"], exp: "Kentucky is the heart of bourbon, home to iconic distilleries like Maker's Mark, Buffalo Trace, and Woodford Reserve." },
      { q: "What is the 'angel's share'?", a: ["The alcohol that evaporates from the barrel during aging", "The portion the master distiller receives", "The first distillate that is discarded", "The liquid remaining in the still"], exp: "The 'angel's share' is the percentage of whisky that evaporates annually through the wooden barrel, typically 2-5% per year." },
      { q: "Which Scottish region is famous for peated, island whiskies?", a: ["Islay", "Speyside", "Highlands", "Lowlands"], exp: "Islay is the Scottish island known for its intensely smoky, peated whiskies, with distilleries like Laphroaig, Ardbeg, and Bowmore." },
      { q: "What distinguishes Tennessee whiskey from bourbon?", a: ["Tennessee undergoes the Lincoln County Process (maple charcoal filtering)", "Tennessee is made in Tennessee and bourbon in Kentucky", "Tennessee has a higher corn content", "They only differ by trade name"], exp: "Tennessee Whiskey (like Jack Daniel's) uses the Lincoln County Process: slow filtering through maple charcoal before aging." },
      { q: "Which classic cocktail uses rye whiskey, sweet vermouth, and Angostura bitters?", a: ["Manhattan", "Old Fashioned", "Sazerac", "Whisky Sour"], exp: "The Manhattan is one of the great American cocktails: rye whiskey or bourbon, sweet vermouth, and Angostura bitters, served with a cherry." },
      { q: "What does 'blended' mean in whisky?", a: ["A blend of different malts and/or grains from multiple distilleries", "Mixed with water before bottling", "A whisky with several aging years combined", "Aged in different wood types"], exp: "Blended whisky combines malts from various distilleries with grain whiskies, seeking consistency and balance. Johnnie Walker is the world's best-selling." },
      { q: "What is 'double distillation' in Scotch?", a: ["Distillation in copper pot stills twice for greater purity", "Aging in two types of barrel", "Blending two different distillates", "Fermentation in two phases"], exp: "Most Scotch single malt is distilled twice in copper pot stills, concentrating flavors and removing impurities." },
      { q: "Which cocktail contains bourbon, sugar, Angostura bitters, and orange peel?", a: ["Old Fashioned", "Whisky Sour", "Mint Julep", "Boulevardier"], exp: "The Old Fashioned is one of the oldest cocktails: sugar, Angostura bitters, a splash of water, bourbon or rye, and orange peel." },
      { q: "What makes Japanese whisky special?", a: ["Precision, balance, and Japanese technique; inspired by Scotland but with unique character", "It only uses water from Mount Fuji springs", "It always includes cherry wood aging", "It is made exclusively from rice"], exp: "Japanese whisky, initiated by Masataka Taketsuru and Shinjiro Torii in the 1920s, combines Scottish technique with Japanese philosophy of precision and harmony." }
    ]
  },
  {
    id: 9,
    title: "Modern Mixology",
    subtitle: "21st Century Trends",
    icon: "⚗️",
    color: "#1abc9c",
    questions: [
      { q: "What is an Aperol Spritz?", a: ["Aperol, prosecco, and soda with orange", "Campari, white wine, and lime", "Aperol, gin, and soda water", "Aperol, vermouth, and ice"], exp: "The Aperol Spritz follows the 3-2-1 recipe: 3 parts prosecco, 2 Aperol, 1 soda, with orange. A global phenomenon of recent years." },
      { q: "What is molecular mixology?", a: ["Applying gastronomy techniques and science to cocktail making", "Mixing only pure alcohol molecules", "Ice-free cocktails using cryogenic technology", "Cocktails made only from mineral water"], exp: "Molecular mixology uses avant-garde kitchen tools (spherification, gelification, foams, liquid nitrogen) to create innovative cocktails." },
      { q: "What is a milk-clarified cocktail?", a: ["A cocktail washed with milk to obtain a clear, silky liquid", "A cocktail with fresh milk added at the end", "A cocktail and milk smoothie", "A long drink with skim milk"], exp: "Milk punch clarification uses milk protein to capture turbidity particles. The milk curdles, is filtered, and the result is a crystal-clear, smooth cocktail." },
      { q: "What is a 'shrub' in modern cocktail making?", a: ["A syrup made from vinegar, fruit, and sugar", "A type of ground mint", "Herbs macerated in alcohol", "Fermented fruit juice"], exp: "A shrub (or drinking vinegar) is a concentrate of vinegar, fruit, and sugar that adds complex acidity and nuance to cocktails without using citrus." },
      { q: "What is the 'low and no' movement in cocktails?", a: ["A trend of low-ABV or non-alcoholic cocktails", "Cocktails with little or no sugar", "Reducing the number of ingredients to a minimum", "Low-priced unbranded drinks"], exp: "The low-ABV and non-alcoholic movement responds to growing demand for alternatives for those who don't drink alcohol or want to moderate consumption." },
      { q: "What is 'umami' in the context of cocktails?", a: ["The fifth basic taste (savory-protein) that adds depth to the cocktail", "A type of Japanese bitter", "A technique for balancing sweet and bitter", "A Japanese seaweed distillate"], exp: "Umami is the fifth basic taste. In cocktails it is achieved with ingredients like soy sauce, kombu, dried tomato, or miso to add depth and roundness." },
      { q: "What is a 'batch cocktail'?", a: ["A cocktail prepared in large quantities in advance for quick service", "A cocktail made with a single spirit", "A cocktail with multiple visible layers", "A cocktail for sharing among several people"], exp: "Batch cocktails are pre-mixed, diluted, and balanced preparations in bottles or containers, ready to serve without mixing on the spot." },
      { q: "What is the 'nitro' technique?", a: ["Adding liquid nitrogen or serving via nitrogen tap for silky texture and extreme cold", "Infusing with nitrous oxide (N2O)", "Using dry ice in the presentation", "Ultra-fast cooling with carbon"], exp: "Liquid nitrogen in cocktails creates spectacular vapor effects and chills instantly. Nitrogen taps give a creamy texture to coffee and cocktails." },
      { q: "What is the 'Paper Plane' cocktail and what characterizes it?", a: ["Equal parts bourbon, Aperol, Amaro Nonino, and lemon juice", "Gin, Aperol, prosecco, and lemon", "Bourbon, triple sec, Campari, and lime", "Rye whiskey, Fernet, Aperol, and orange juice"], exp: "The Paper Plane, created by Sam Ross in 2008, is a model of perfect balance: 3/4 oz each of bourbon, Aperol, Amaro Nonino, and lemon juice." },
      { q: "What is 'terroir' applied to spirits?", a: ["The set of geographic, climatic, and soil factors that influence the spirit's flavor", "The aging technique at the place of production", "Only the type of water used in distillation", "The harvesting method for raw materials"], exp: "As with wine, terroir in spirits describes how soil, climate, local water, and microbiome influence the final flavor, especially in tequila, whisky, and rhum agricole." }
    ]
  },
  {
    id: 10,
    ...
    color: "#d4a017",
    questions: [
      { q: "What is a Negroni Sbagliato and how does it differ from a classic Negroni?", a: ["It uses prosecco instead of gin; sbagliato means 'mistake' in Italian", "It uses vodka instead of gin", "It is served with gin tonic instead of ice", "It is a Negroni without Campari"], exp: "The Negroni Sbagliato ('wrong' in Italian) arose when a Bar Basso bartender in Milan mistakenly used prosecco instead of gin; the mistake was a success." },
      { q: "What is the exact proportion of a classic IBA Daiquiri?", a: ["6 cl white rum, 2 cl triple sec, 1.5 cl lime juice", "3 cl rum, 3 cl lime, 1 cl sugar", "4.5 cl rum, 2.5 cl lime, 1.5 cl syrup", "2 oz rum, 1 oz lime, 0.5 oz syrup"], exp: "The official IBA Daiquiri: 6 cl white rum, 2 cl triple sec or curaçao, 1.5 cl fresh lime juice. Served in a cocktail glass." },
      { q: "Which cocktail contains both rye whiskey and Cognac?", a: ["Vieux Carré", "Manhattan", "Sidecar", "Sazerac"], exp: "The Vieux Carré, created at the Hotel Monteleone in New Orleans, contains rye whiskey, Cognac, sweet vermouth, Bénédictine, and two types of bitters." },
      { q: "What is the Hanky Panky?", a: ["Gin, sweet vermouth, and Fernet-Branca", "Vodka, cherry liqueur, and soda", "Bourbon, Aperol, and angostura", "Gin, Campari, and grapefruit juice"], exp: "The Hanky Panky was created by Ada Coleman at the Savoy Hotel in London around 1900: gin, sweet vermouth, and a dash of Fernet-Branca." },
      { q: "What is crème de violette?", a: ["A violet flower liqueur, essential in the Aviation", "A floral-flavored dessert cream", "A French wild berry syrup", "An Austrian violet bitter"], exp: "Crème de violette is a liqueur made from violet flowers. It is the ingredient that gives the Aviation cocktail its characteristic mauve color, which was scarce for decades." },
      { q: "What are the four ingredients of 'Naked and Famous'?", a: ["Mezcal, Aperol, Yellow Chartreuse, and lime juice in equal parts", "Tequila, Campari, Cointreau, and lime", "Mezcal, Aperol, Fernet, and lemon", "Gin, Yellow Chartreuse, Aperol, and grapefruit"], exp: "The Naked and Famous, created by Joaquín Simó in 2011 in New York, is another equal-parts cocktail: young mezcal, Aperol, Yellow Chartreuse, and lime juice." },
      { q: "What is 'basic spherification' applied to a cocktail?", a: ["Creating cocktail liquid spheres that burst when eaten using alginate and calcium chloride", "Serving the cocktail inside an ice sphere", "Presenting the cocktail in a chocolate ball", "Using 60mm ice spheres for an Old Fashioned"], exp: "Basic spherification, popularized by Ferran Adrià, uses sodium alginate and calcium chloride to create spheres with a thin membrane containing liquid that bursts in the mouth." },
      { q: "When is a vermouth considered 'extra dry'?", a: ["When it contains less than 30 grams of sugar per liter", "When it is aged less than 1 month", "When it has more than 20% ABV", "When it is made without sweet botanicals"], exp: "Extra dry vermouth has a very low sugar content (less than 30 g/l), making it the driest of all vermouth categories." },
      { q: "What makes the 'Clover Club' cocktail special?", a: ["It contains egg white that gives it a foamy texture", "It uses four types of spirits", "It is served in four glasses at once", "It has four layers of different colors"], exp: "The Clover Club (pre-Prohibition) contains gin, lemon juice, raspberry syrup, and whisked egg white, giving it its characteristic foamy texture and pink appearance." },
      { q: "Which Scottish distillery was the first to bottle single malt Scotch for the global market?", a: ["Glenfiddich (1963)", "Macallan (1970)", "Laphroaig (1950)", "Balvenie (1973)"], exp: "Glenfiddich launched in 1963 the first single malt Scotch Whisky actively marketed internationally, changing the industry forever." }
    ]
  },
  {
    id: 11,
